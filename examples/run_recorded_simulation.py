...
me_ms = 3.e-6 # mass ratio between the Earth and the Sun

sim.particles.add(mass=0.0898, pos=(0.0, 0.0, 0.0), vel=(0.0, 0.0, 0.0), name='star')
sim.particles.add(mass=1.374*me_ms, a=0.01154, e=0.00622, i=np.radians(89.56), name='b', primary='star',f=2*np.pi*np.random.rand())
sim.particles.add(mass=1.308*me_ms, a=0.01580, e=0.01580, i=np.radians(89.70), name='c', primary='star',f=2*np.pi*np.random.rand())
sim.particles.add(mass=0.388*me_ms, a=0.02227, e=0.00837, i=np.radians(89.89), name='d', primary='star',f=2*np.pi*np.random.rand())
sim.particles.add(mass=0.692*me_ms, a=0.02925, e=0.00510, i=np.radians(89.736), name='e', primary='star',f=2*np.pi*np.random.rand())
sim.particles.add(mass=1.039*me_ms, a=0.03849, e=0.01007, i=np.radians(89.719), name='f', primary='star',f=2*np.pi*np.random.rand())
sim.particles.add(mass=1.321*me_ms, a=0.04683, e=0.00208, i=np.radians(89.721), name='g', primary='star',f=2*np.pi*np.random.rand())
sim.particles.add(mass=0.326*me_ms, a=0.06189, e=0.00567, i=np.radians(89.796), name='h', primary='star',f=2*np.pi*np.random.rand())
